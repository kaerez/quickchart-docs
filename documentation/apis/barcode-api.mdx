...
| `format`      | No       | Output format for the barcode. Defaults to `png`.                        | `png`, `svg`                                          |
...
To generate a barcode in SVG format instead of PNG:

```
https://quickchart.io/barcode?type=code128&text=SVG-Example&format=svg
```
